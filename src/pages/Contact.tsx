              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-primary-dark/50 border border-secondary/20 rounded-lg text-secondary-light focus:outline-none focus:border-primary"
                    required
                  />
                </div>
                <div>
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-3 bg-primary text-white rounded-full hover:bg-primary/90 transition-colors duration-300 glow-effect"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="cosmic-card">
                ...
                <div className="space-y-4">
                  <p className="text-secondary-light">
                    <span className="text-primary">Email:</span> contact@novamind.com
                  </p>
                  <p className="text-secondary-light">
                    <span className="text-primary">Phone:</span> +1 (555) 123-4567
                  </p>
                  <p className="text-secondary-light">
                    <span className="text-primary">Address:</span> 123 Space Street, Cosmos City
                  </p>
                </div>
              </div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      className="text-secondary-light hover:text-primary transition-colors duration-300"
                    >
                      {social.icon}
                    </a>
                  ))}
